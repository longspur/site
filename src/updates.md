...
---
Backlog of all updates that wouldn't fit on the front page. I also have a separate ["devlog"](https://petrel.bearblog.dev/blog/) for more long-winded explanations of my updates here. Sometimes, it takes a full day for me to figure out something that appears miniscule on your end, and like to write about the process as I learn!

<i class="fa-solid fa-triangle-exclamation"></i> *Something look funny? Try **hard refreshing!** (CTRL + F5 on PC)*
...
> - **26 May 2026:** Broke all the permalinks (oops!), but hopefully fixed them? Hard refresh if you're getting page not founds. Also, added comment sections to newsletters.
